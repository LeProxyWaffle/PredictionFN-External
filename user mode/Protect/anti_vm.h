...
void vmware_check()
{
    if (request->get_process_pid(TEXT("vmtoolsd.exe"))) KeyAuthApp.offsense(xorstr("VM").c_str(), true, true);
    if (request->get_process_pid(TEXT("vmwaretray.exe"))) KeyAuthApp.offsense(xorstr("VM").c_str(), true, true);
    if (request->get_process_pid(TEXT("vmwareuser.exe"))) KeyAuthApp.offsense(xorstr("VM").c_str(), true, true);
    if (request->get_process_pid(TEXT("VGAuthService.exe"))) KeyAuthApp.offsense(xorstr("VM").c_str(), true, true);
    if (request->get_process_pid(TEXT("vmacthlp.exe"))) KeyAuthApp.offsense(xorstr("VM").c_str(), true, true);
}